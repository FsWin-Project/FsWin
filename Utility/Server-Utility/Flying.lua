local suspiciousName = 'a9Z7TpLm2QvYc8BwRfJs1HgNeDuEjOoVzXkPmRwSqLtUvBnCy'

if not workspace:FindFirstChild(suspiciousName) then return end
...
TextLabel.Text = "Made by after x"
